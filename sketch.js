...
function preload() {
  ...
  boatFrames = loadJSON("assets/boat/broken_boat.json")
  boatPicture = loadImage("assets/boat/broken_boat.png")
...
function setup() {
  ...
  var brokenBoatFrames = boatFrames.frames;
  for (var i = 0; i < brokenBoatFrames.length; i++) {
    var pos = brokenBoatFrames[i].position;
    var img = boatPicture.get(pos.x, pos.y, pos.w, pos.h);
